<div class="footer">
    <div class="page-container footer-container">
        <div class="footer-cities">
            ...
            <div class="footer-city">
                <a href="property_list.php?city=Meerut">PG in Meerut</a>
            </div>
            <div class="footer-city">
                <a href="property_list.php?city=Noida">PG in Noida</a>
            </div>
            <div class="footer-city">
                <a href="property_list.php?city=Ghaziabad">PG in Ghaziabad</a>
            </div>
        </div>
